...
Some examples of Thermo Forge plugin in action:
  ...
  <figure style="display:inline-block; margin:10px; width:385px;">
    <img src="Resources/Demo1.gif" alt="Room with spotlight accuracy" width="385"/>
  ...
  <figure style="display:inline-block; margin:10px; width:385px;">
    <img src="Resources/Demo2.gif" alt="Activate in Plugins menu" width="385"/>
    <figcaption align="center">
  ...
  <figure style="display:inline-block; margin:10px; width:385px;">
    <img src="Resources/Demo3.gif" alt="Heat distribution" width="385"/>
    <figcaption align="center">
     Multiple heat sources and multiple volumes with gradual dispersion and constant temperature options.
    </figcaption>
  </figure>
  <figure style="display:inline-block; margin:10px; width:385px;">
    <img src="Resources/Demo4.gif" alt="Editor preview tools" width="385"/>
    <figcaption align="center">
  ...
  <figure style="display:inline-block; margin:10px; width:385px;">
    <img src="Resources/Demo5.gif" alt="Heat distribution" width="385"/>
    <figcaption align="center">
  ...
  <figure style="display:inline-block; margin:10px; width:385px;">
    <img src="Resources/Demo6.gif" alt="Editor preview tools" width="385"/>
    <figcaption align="center">
